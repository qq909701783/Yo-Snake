import torch
import numpy as np
from utils.snake import snake_decode, snake_config
from utils import data_utils
from models.csrc.extreme_utils import _ext as extreme_utils
...
def get_gcn_feature(cnn_feature, img_poly, ind, h, w):
    ###将多边形坐标转换到[-1,1]上，映射到原图特征图坐标范围内###
    img_poly = img_poly.clone()
    img_poly[..., 0] = img_poly[..., 0] / (w / 2.) - 1
    img_poly[..., 1] = img_poly[..., 1] / (h / 2.) - 1

    ###在原始特征图坐标空间内使用双线性插值得到多边行顶点的特征表示###
